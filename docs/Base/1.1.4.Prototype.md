...
Desenvolvemos um protótipo de alta fidelidade para ilustrar o funcionamento e a navegação do aplicativo **FCTE Hoje**. O foco principal é centralizar e facilitar o acesso a informações relevantes do campus, como notícias, eventos, oportunidades acadêmicas e o cardápio do Restaurante Universitário (RU).
...
# 1. Tela Home (Início)
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/home_Prototype.png" alt="Tela Home" width="350"/>
...
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/Notícias_Prototype.png" alt="Tela Notícias" width="350"/>
  <p>Feed com publicações recentes do campus, filtráveis por data.</p>
</div>

## 2.2. Visualização de Notícia
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/VisualizaçãoDeNotícia_Prototype.png" alt="Visualização de Notícia" width="350"/>
...
## 3.1. Tela de Eventos
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/Eventos_Prototype.png" alt="Tela Eventos" width="350"/>
  <p>Lista de atividades acadêmicas com abas para filtrar por Palestras, Debates e Workshops.</p>
</div>

## 3.2. Tela de Agenda
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/Agenda_Prototype.png" alt="Tela Agenda" width="350"/>
...
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/Oportunidades_Prototype.png" alt="Tela Oportunidades" width="350"/>
  <p>Mural de vagas dividido em Bolsas, Empresas Jr. e Estágios.</p>
</div>

## 4.2. Cardápio do RU
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/CardápioRU_Prototype.png" alt="Cardápio RU" width="350"/>
...
## 5.1. Salvos
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/Salvos_Prototype.png" alt="Tela Salvos" width="350"/>
  <p>Lista de acesso rápido para itens (Notícias, Eventos, Oportunidades) favoritados pelo usuário.</p>
</div>

## 5.2. Notificações
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/Notificações_Prototype.png" alt="Tela Notificações" width="350"/>
  <p>Central de alertas (Alertas) sobre publicações, mudanças no cardápio ou prazos.</p>
</div>

## 5.3. Preferências
<div align="center">
  <img src="https://github.com/UnBArqDsw2026-1-Turma01/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/blob/main/docs/Assets/Preferencias_Prototype.png" alt="Tela Preferências" width="350"/>
