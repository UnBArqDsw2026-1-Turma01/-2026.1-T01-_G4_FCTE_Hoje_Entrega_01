...
| Aluno  | Participação|
| -- | -- |
|  Arthur Gomes Oliveira | Criação da [Modelagem do FCTE Hoje](https://unbarqdsw2026-1-turma01.github.io/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/#/Base/1.3.ModelagemBPMN?id=modelagem-do-fcte-hoje) |
...
|  Felipe Guimaraes Fernandes | Criação da [Modelagem do FCTE Hoje](https://unbarqdsw2026-1-turma01.github.io/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/#/Base/1.3.ModelagemBPMN?id=modelagem-do-fcte-hoje) |
...
|  Felipe Matheus Ribeiro Lopes | Criação da [Modelagem do FCTE Hoje](https://unbarqdsw2026-1-turma01.github.io/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/#/Base/1.3.ModelagemBPMN?id=modelagem-do-fcte-hoje) |
...
|  Pedro Miguel Martins de Oliveira dos Santos | Criação da [Modelagem do FCTE Hoje](https://unbarqdsw2026-1-turma01.github.io/-2026.1-T01-_G4_FCTE_Hoje_Entrega_01/#/Base/1.3.ModelagemBPMN?id=modelagem-do-fcte-hoje) |
...
O diagrama abaixo representa o fluxo de atividades do aplicativo FCTE Hoje, organizado em três frentes: Usuário Leitor, Sistema (App) e Publicador (FCTE Hoje).

O fluxo do publicador se inicia com a seleção do tipo de conteúdo a ser criado: notícia, evento, oportunidade, que é então subido para o sistema, o qual realiza a publicação automaticamente e notifica os leitores.

Do lado do leitor, o processo começa com a abertura do app e a visualização do feed. A partir daí, o usuário pode seguir três caminhos: filtrar o conteúdo por categoria ou data, abrir e ler uma publicação, podendo salvá-la internamente ou exportar um evento para o Google Agenda, ou configurar suas preferências, que alimentam o sistema para recomendar conteúdos mais relevantes. Ao fim de qualquer um desses caminhos, o fluxo converge e se encerra.

<p align="center"><strong>Figura 5: Modelagem BPMN do FCTE Hoje</strong></p>

**![BPMNPReview](../Assets/BPMN/BPMN_FCTE_Hoje.png)**

<p align="center"><em>Autor: <a href="https://github.com/arthurgomes1290">Arthur Gomes</a>, <a href="https://github.com/felipegf1">Felipe Guimarães</a>, <a href="https://github.com/femathrl0">Felipe Matheus</a> e  <a href="https://github.com/pedromadbr">Pedro Miguel</a></em></p>
...
| `1.5` | 05/04/2026 | Adição do BPMN da modelagem do FCTE Hoje. | [Felipe Guimaraes](https://github.com/felipegf1) | [Tiago Lemes](https://github.com/TiagoTeixeira-2005) | 05/04/2026 |
