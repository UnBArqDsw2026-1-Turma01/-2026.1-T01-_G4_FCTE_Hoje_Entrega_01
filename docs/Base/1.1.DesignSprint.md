...
De acordo com o *[Design Sprint da Google](https://www.gv.com/sprint/)*, o Design Sprint é uma metodologia criada pelo Google Ventures para validar ideias e resolver grandes desafios de negócio em apenas cinco dias, por meio de um processo dividido em fases bem definidas.
...
- [Rich Picture Escolhido](/Base/1.1.3.Decision.md): Com base nos Rich Pictures gerados, foi selecionado aquele que melhor representa o sistema, por apresentar de forma clara, organizada e completa os principais atores, funcionalidades e interações relacionadas ao FCTE Hoje.
- [É, Não é, Faz, Não faz](/Base/1.1.3.1.E_NaoE_Faz_NaoFaz.md): Utilizada para delimitar o escopo do sistema, definindo claramente o que ele é e não é, bem como o que faz e não faz. Essa análise ajudou na tomada de decisão, garantindo que a proposta escolhida permanecesse alinhada aos objetivos do projeto.
...
| `1.1` | 04/04/2026 | Atualização dos hyperlinks | [Tiago Lemes](https://github.com/TiagoTeixeira-2005)  | | |
